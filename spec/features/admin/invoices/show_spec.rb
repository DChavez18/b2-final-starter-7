...
describe "Admin Invoices Index Page" do
  before :each do
    ...
    @bulk_discount = BulkDiscount.create!(name: "Summer Sale", percentage_discount: 10, quantity_threshold: 10, merchant_id: @m1.id)

    @item_1.bulk_discount = @bulk_discount
    @item_1.save!
...
# And I see the total discounted revenue from this invoice which 
# includes bulk discounts in the calculation
